...
strata_names <- c("Backwater, Contiguous Shoreline", 
                  ...
                  "Side Channel Border", 
                  "Tailwater Zone") 
strata_codes <- c("BWC-S", "IMP-O", "IMP-S", "MCB-U", "MCB-W", "SCB", "TWZ")
...
strataColors_codes <- c("chartreuse3", "blue", "dodgerblue2", "red", "darkred", "orange", "magenta")
names(strataColors_codes) <- strata_codes
